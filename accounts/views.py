...
def registerPage(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.success(request, 'Thank you for registering with us. We have emailed you the verification address. Please verify it.')
        ...
        if user is not None:
            try:
                ...
                if is_cart_item_exists:
                    ...
                    # GETTING THE CART ITEMS FROM THE USER TO ACCESS HIS/HER PRODUCTS
